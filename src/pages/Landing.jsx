...
const BRAND = 'var(--accent)';      // single brand accent (teal/cyan family)
const BRAND_LIGHT = '#7dd3fc';
const ALERT = 'var(--danger)';      // single alert colour
    ...
    <div className="lp-page" style={{ background: 'var(--surface-2)', color: 'var(--text)', fontFamily: 'Inter, system-ui, sans-serif', overflowY: 'auto' }}>
      ...
      <div className="lp-pad" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, minWidth: 0 }}>
          <div style={{ width: 34, height: 34, borderRadius: 8, background: 'linear-gradient(135deg, var(--brand-2), var(--accent))', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 700, fontSize: 13, color: 'white', flexShrink: 0 }}>HF</div>
      ...
      <div className="lp-pad" style={{
        position: 'relative',
        background: 'linear-gradient(115deg, var(--sidebar-bg) 0%, #1e3a5f 50%, #14545c 100%)',
        color: 'white',
        ...
        <div className="lp-grid2" style={{ maxWidth: 1320, margin: '0 auto', position: 'relative' }}>
          <div style={{ minWidth: 0 }}>
            ...
            <div style={{ display: 'flex', gap: 12, marginBottom: 36, flexWrap: 'wrap' }}>
              <button onClick={() => onNavigate('welcome')} style={{ padding: '14px 28px', background: 'white', color: 'var(--sidebar-bg)', border: 'none', borderRadius: 8, fontSize: 15, fontWeight: 600, cursor: 'pointer', boxShadow: '0 4px 24px rgba(0,0,0,0.2)', minHeight: 44 }}>
                Start your forecast
              </button>
          ...
          <div style={{ position: 'relative', minWidth: 0 }}>
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 12 }}>
                ...
                <div style={{ flex: 1, minWidth: 0, height: 22, background: 'var(--surface-3)', borderRadius: 4, marginLeft: 8, display: 'flex', alignItems: 'center', padding: '0 8px', fontSize: 10, color: 'var(--text-4)', overflow: 'hidden', whiteSpace: 'nowrap' }}>healthforecast.jlwanalytics.com</div>
              </div>
              <div style={{ background: 'var(--surface-2)', borderRadius: 6, padding: 'clamp(8px, 2vw, 14px)' }}>
                ...
                <svg viewBox="0 0 320 100" width="100%" height="100" preserveAspectRatio="none">
                  ...
                  <text x="164" y="14" fontSize="9" fill="var(--text-3)">Forecast &rarr;</text>
                </svg>
        ...
        <div style={{ maxWidth: 1320, margin: '0 auto' }}>
          ...
          <div className="lp-cards3">
            {[
              ...
              <div key={s.t} style={{ padding: 'clamp(20px, 4vw, 32px)', background: 'var(--surface-2)', borderRadius: 12, borderLeft: `3px solid ${ALERT}` }}>
                <div style={{ fontSize: 'clamp(1.1rem, 2.6vw, 1.3rem)', fontWeight: 600, color: 'var(--text)', letterSpacing: '-0.3px', lineHeight: 1.3, marginBottom: 10 }}>{s.t}</div>
                <div style={{ fontSize: 14, color: '#475569', lineHeight: 1.55, marginBottom: 14 }}>{s.d}</div>
                <div style={{ fontSize: 11.5, color: 'var(--text-3)', lineHeight: 1.5, paddingTop: 12, borderTop: '1px solid var(--divider)' }}>{s.f}</div>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="lp-steps">
            {[
              ...
              <div key={s.n} style={{ position: 'relative', textAlign: 'center' }}>
                ...
                <div style={{ fontSize: 16, fontWeight: 600, color: 'var(--text)', marginBottom: 6 }}>{s.t}</div>
                <div style={{ fontSize: 12, color: 'var(--text-3)', lineHeight: 1.5 }}>{s.d}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* TRUST */}
      <div id="section-models" className="lp-pad" style={{ paddingTop: 'clamp(56px, 9vw, 100px)', paddingBottom: 'clamp(56px, 9vw, 100px)', background: 'linear-gradient(180deg, var(--sidebar-bg) 0%, #1e3a5f 100%)', color: 'white' }}>
        <div style={{ maxWidth: 1320, margin: '0 auto' }}>
        ...
        <div style={{ maxWidth: 1320, margin: '0 auto' }}>
          ...
          <div className="lp-cards3" style={{ marginBottom: 24 }}>
            {[
              ...
              <div key={s.v} style={{ padding: 'clamp(20px, 4vw, 32px)', background: 'var(--surface-2)', borderRadius: 12, textAlign: 'center', border: '1px solid var(--divider)' }}>
        ...
        <div style={{ maxWidth: 1320, margin: '0 auto' }}>
          <div className="lp-grid2" style={{ marginBottom: 'clamp(32px, 6vw, 56px)' }}>
            <div style={{ padding: 'clamp(20px, 4vw, 28px)', background: '#f0f5fa', borderRadius: 12, border: '1px solid #dbe7f2', minWidth: 0 }}>
              ...
              <div style={{ fontSize: 16, fontWeight: 600, color: 'var(--text)', marginBottom: 8 }}>One document, board-ready</div>
            ...
            <div style={{ padding: 'clamp(20px, 4vw, 28px)', background: '#f0f5fa', borderRadius: 12, border: '1px solid #dbe7f2', minWidth: 0 }}>
              ...
              <div style={{ fontSize: 16, fontWeight: 600, color: 'var(--text)', marginBottom: 8 }}>The warning before the shift</div>
              <div style={{ fontSize: 13.5, color: '#475569', lineHeight: 1.6 }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: 24 }}>
            <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: 1.5, color: 'var(--brand)', textTransform: 'uppercase', marginBottom: 12 }}>The AI analyst, in action</div>
            <h2 className="lp-h2" style={{ marginBottom: 0 }}>Ask it a question. Get a straight answer.</h2>
          </div>
          <div style={{ maxWidth: 640, margin: '0 auto', background: 'var(--sidebar-bg)', borderRadius: 14, padding: 'clamp(18px, 3vw, 26px)' }}>
          ...
          <div style={{ marginTop: 'clamp(48px, 8vw, 80px)' }}>
            <div style={{ textAlign: 'center', marginBottom: 28 }}>
              <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: 1.5, color: 'var(--brand)', textTransform: 'uppercase', marginBottom: 12 }}>Not just Emergency</div>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: 6, marginBottom: 20, flexWrap: 'wrap' }}>
              {DEPARTMENTS.map((d) => (
                <button key={d.id} onClick={() => setDept(d.id)} style={{
                  ...
                  border: `1px solid ${dept === d.id ? BRAND : 'var(--border)'}`,
                  background: dept === d.id ? BRAND : 'white',
                  color: dept === d.id ? 'white' : '#475569',
                }}>{d.label}</button>
              ))}
            </div>
            <div style={{ maxWidth: 520, margin: '0 auto', background: 'white', border: '1px solid var(--divider)', borderRadius: 12, padding: 'clamp(14px, 3vw, 20px)', boxShadow: '0 8px 24px rgba(15,23,42,0.06)' }}>
      ...
      <div className="lp-pad" style={{
        ...
        background: 'linear-gradient(110deg, var(--sidebar-bg) 0%, #1e5b8a 60%, #14545c 100%)',
        ...
        <div style={{ maxWidth: 700, margin: '0 auto', position: 'relative' }}>
          ...
          <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
            <button onClick={() => onNavigate('welcome')} style={{ padding: '16px 32px', background: 'white', color: 'var(--sidebar-bg)', border: 'none', borderRadius: 8, fontSize: 15, fontWeight: 600, cursor: 'pointer', minHeight: 44 }}>Start your forecast</button>
      ...
      <div className="lp-pad" style={{ background: '#0a1120', color: 'var(--text-4)', paddingTop: 48, paddingBottom: 32 }}>
        <div className="lp-foot" style={{ maxWidth: 1320, margin: '0 auto' }}>
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
              <div style={{ width: 32, height: 32, borderRadius: 6, background: 'linear-gradient(135deg, var(--brand-2), var(--accent))', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 700, fontSize: 13, color: 'white' }}>HF</div>
          ...
          <div>
            ...
            <a href={WALKTHROUGH_MAILTO} style={{ display: 'block', fontSize: 13, padding: '5px 0', color: 'var(--text-4)', textDecoration: 'none' }}>Book a walkthrough</a>
